...
- `gdb` pour déterminer les offsets exacts du canary et de `saved RIP`
- `pwntools` (`flat`, `asm`, `shellcraft`) pour assembler le payload
- `hexdump` pour vérifier l’alignement
